...
use crate::utils::{
    ArchiveBranchParser, ArchivedBranchProcessor, ParaError, Result, TimestampSortable,
};
...
impl TimestampSortable for RecoveryInfo {
...
impl<'a> SessionRecovery<'a> {
    ...
    pub fn list_recoverable_sessions(&self) -> Result<Vec<RecoveryInfo>> {
        ...
        processor.list_and_process(|archived_branch| self.parse_archived_branch(archived_branch))
    }
