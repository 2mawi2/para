// Re-export the main functionality from the resume module
pub use resume::execute;
...
mod tests {
    ...
    fn test_resume_specific_session_workflow() {
        ...
        let result = super::execute(config, args);
        assert!(result.is_ok());
    ...
    fn test_validate_resume_args() {
        ...
        let result = super::execute(config, args_copy);
