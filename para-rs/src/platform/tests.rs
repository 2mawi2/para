#[cfg(test)]
mod platform_tests {
    use crate::platform::{get_platform_manager, PlatformManager, GenericPlatform};
    ...
    #[cfg(target_os = "macos")]
    mod macos_tests {
        use crate::platform::{PlatformManager, macos::MacOSPlatform};
    ...
    mod generic_tests {
        use crate::platform::{PlatformManager, GenericPlatform};
